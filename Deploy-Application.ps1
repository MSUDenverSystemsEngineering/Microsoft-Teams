...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Write-Log -Message $CurrentConsoleUserSession -Severity 3 -Source $deployAppScriptFriendlyName
		Write-Log -Message $CurrentLoggedOnUserSession -Severity 3 -Source $deployAppScriptFriendlyName
		Write-Log -Message $RunAsActiveUser -Severity 3 -Source $deployAppScriptFriendlyName
		...
		$exitCode = Execute-ProcessAsUser -Path "${dirFiles}\Teams_windows_x64.exe" -Parameters "--silent" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'teams' -CloseAppsCountdown 60
		...
		$exitCode = Execute-ProcessAsUser -Path "${envLocalAppData}\Microsoft\Teams\Update.exe" -Parameters "--uninstall -s" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCmpcyX7NmRX2U9
# ckNKjX1vhF2rR0hkdiRK1HvR1vALlaCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEILuI
# 3qIV8UssmSMZXC+PnaYUkfaA6RkHx4dXt15MwqIcMA0GCSqGSIb3DQEBAQUABIIB
# AIcWIo+1V4l3ua02qir6FgYMz9//5ZUqm6IluGLJ8Xpgwz1rfYhhrLPsCvtJxs8M
# Kt6X3JqWAwMSArTcPkptF6l6AoFjxRUqm1WdOZnCymRrsKw1cDKDhp+OUb/QbZm2
# WKUXWasPS27oS7Ie4OMK8dGrOFJaLJqGMmcMXrc3sBvF9m7or1hoaOm8KmtjWPdi
# O58jyOhgj97CVrkRkdZilAFxaSv6fswJuwdT9dyR1hkG+grZLg9OpGSx0wBYErG7
# cBjHjwTqRQ/sswedAxF+UC9s/7TYzvssQKQ36Bg9sne8jYSn1wAM16aGFrtvVr1m
# hwouCTXk2ACopCImQqjrjKShggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwNjAxMTgzMzE3WjAjBgkqhkiG9w0BCQQxFgQU
# Can+URDboiERbUMOGE8zLomVCZYwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAHd+37lEGhEw0unp3yyfHgBJbmPzWiCyNjiDijvqzr11DXpjiwlS79Wg
# 0SuUsTN7k9m+lzpP+RbxqCzI0iiddsjgZ/6KSPDFmwr0LqFCfy5zjb7xUTlhU8sx
# //Mc9TCbPh27va1ZzPtA2WKLKYhjtiAwiR25dbjXYQXR4KYyeQ8IJ8QsUhEdvrEC
# t3xLy31gGfqnhR8mJgyQQENWVRfrTUisP+flIumvsQCanzHCIb3sOcftHCnSopjd
# x0Fh1G8aTwpfRdHt7q37hWSEGbSoRYwT3kzND1N7WDXBZKO6EAaRSIC3h9bXiYHt
# ScrP5QkUcnzVLL40Sq7ORQLYyED+da8=
