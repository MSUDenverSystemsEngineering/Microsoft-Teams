...
Try {
	...
	[string]$appScriptDate = '09/24/2019'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## Copies the Teams executable into Program Files (x86) and prevents the application from opening on login.
		## See https://docs.microsoft.com/en-us/microsoftteams/msi-deployment#disable-auto-launch-for-the-msi-installer
		$exitCode = Execute-MSI -Action 'Install' -Path 'Teams_windows_x64.msi' -Parameters 'OPTIONS="noAutoStart=true" REBOOT=ReallySuppress /QN' -PassThru
